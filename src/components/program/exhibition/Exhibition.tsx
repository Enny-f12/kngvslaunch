...
const Exhibition: React.FC = () => {
  return (
    <>
      {/* This link should ideally be in your main index.html or App component */}
        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <div className={styles.galleryGrid}>
                    <img src="/assets/Program/exhibition/KNGVS Pro_20240910_120222_1.png" alt="Exhibition Highlight 1" className={styles.galleryImage} />
                    <img src="/assets/Program/exhibition/KNGVS Pro_20240910_120218_1.png" alt="Exhibition Highlight 2" className={styles.galleryImage} />
                    <img src="/assets/Program/exhibition/KNGVS Pro_20240910_120225_1.png" alt="Exhibition Highlight 3" className={styles.galleryImage} />
                </div>
            </div>
        </section>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.galleryGrid}>
                    {highlightsData.images.map((src, index) => (
                        <img key={index} src={src} alt={`Highlight ${index + 1}`} className={styles.galleryImage} />
                    ))}
                </div>
            </div>
        </section>
                ...
                <p className={styles.sectionSubtitle}>{attendanceData.description}</p>
                 <div className={styles.galleryGrid}>
                    {attendanceData.images.map((src, index) => (
                        <img key={index} src={src} alt={`Guest ${index + 1}`} className={styles.galleryImage} />
                    ))}
                </div>
            </div>
        </section>
