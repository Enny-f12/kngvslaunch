...
const WorldFoodDay: React.FC = () => {
  return (
    <div className="min-h-screen px-3 md:px-10 py-4 md:py-16 bg-gray-50">
      {/* Intro Section */}
      <div className="w-full max-w-6xl mx-auto text-left">
       <div className="text-center mt-15 lg:mt-30 text-black">
        ...
        <p className="text-gray-700 max-w-6xl mx-auto leading-relaxed text-lg mb-6">
        ...
        <p className="text-gray-700 max-w-6xl mx-auto leading-relaxed text-lg ">
