 ...
 <p className="text-lg md:text-xl leading-relaxed mt-8">
      ...
      <ul className="flex flex-col gap-4 max-w-6xl mx-auto mb-12 p-0 list-none mt-8">
        {[
          ...
          <li 
            key={index} 
            className="bg-gray-50 px-6 py-4 border-l-4 border-teal-600 rounded-lg text-base text-gray-700 shadow-sm"
          >
            ✓ {recipe}
          </li>
        ))}
      ...
      <h2 className="text-3xl md:text-4xl font-semibold text-center mb-5 mt-10 md:mt-15 lg:mt-30">Amplified Kitchen Pictures</h2>
