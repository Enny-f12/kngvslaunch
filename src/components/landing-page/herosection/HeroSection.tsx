...
const HeroSection: React.FC = () => {
  return (
    <section className="
      w-full 
      flex flex-wrap flex-col lg:flex-row items-center justify-center
      bg-linear-to-b from-white via-[#e6f4e6] to-[#d4efda]
      py-16 px-5 lg:px-8 mt-10 md:mt-30
      gap-10
    ">
      
      {/* IMAGE */}
      <div className="flex-1 min-w-[270px] max-w-xl">
        <Image
      ...
      {/* TEXT BLOCK */}
      <div className="flex-1 min-w-[270px] md:min-w-[300px] max-w-xl text-left">
        ...
        {/* PARAGRAPH */}
        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-700 max-w-xl">
